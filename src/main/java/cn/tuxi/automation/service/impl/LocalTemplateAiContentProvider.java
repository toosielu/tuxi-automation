...
@Component
@Order(100)
public class LocalTemplateAiContentProvider implements AiContentProvider {
    private final ViralContentTemplateLibrary templateLibrary;

    public LocalTemplateAiContentProvider(ViralContentTemplateLibrary templateLibrary) {
